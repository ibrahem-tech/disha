      ...
      <Helmet>
        <style>
          ...
          @font-face {
              ...
              src: url(${
                process.env.PUBLIC_URL +
                "/assets/fonts/Perpetua-Bold/Perpetua-Bold.eot?#iefix"
              }) format("embedded-opentype"),
              url(${
                process.env.PUBLIC_URL +
                "/assets/fonts/Perpetua-Bold/Perpetua-Bold.woff2"
              }) format("woff2"),
              url(${
                process.env.PUBLIC_URL +
                "/assets/fonts/Perpetua-Bold/Perpetua-Bold.woff"
              }) format("woff"),
              url(${
                process.env.PUBLIC_URL +
                "/assets/fonts/Perpetua-Bold/Perpetua-Bold.ttf"
              }) format("truetype"),
              url(${
                process.env.PUBLIC_URL +
                "/assets/fonts/Perpetua-Bold/Perpetua-Bold.svg#Perpetua-Bold"
              }) format("svg");
          }
          ...
          @font-face {
            ...
            font-style: normal;
            src: url(${
              process.env.PUBLIC_URL + "/assets/fonts/Perpetua/Perpetua.eot"
            });
            src: url(${
              process.env.PUBLIC_URL +
              "/assets/fonts/Perpetua/Perpetua.eot?#iefix"
            }) format('embedded-opentype'),
                url(${
                  process.env.PUBLIC_URL +
                ...
                url(${
                  process.env.PUBLIC_URL +
                  "/assets/fonts/Perpetua/Perpetua.woff"
                }) format('woff'),
                url(${
                  process.env.PUBLIC_URL + "/assets/fonts/Perpetua/Perpetua.ttf"
                }) format('truetype'),
                url(${
                  process.env.PUBLIC_URL +
                  "/assets/fonts/Perpetua/Perpetua.svg#Perpetua"
                }) format('svg');
