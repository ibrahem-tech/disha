      ...
      <Helmet>
        <style>
          ...
          @font-face {
              ...
              src: url(${
                process.env.PUBLIC_URL +
                "/assets/fonts/Rockwell-Bold/Rockwell-Bold.eot?#iefix"
              }) format("embedded-opentype"),
              url(${
                process.env.PUBLIC_URL +
                "/assets/fonts/Rockwell-Bold/Rockwell-Bold.woff2"
              }) format("woff2"),
              url(${
                process.env.PUBLIC_URL +
                "/assets/fonts/Rockwell-Bold/Rockwell-Bold.woff"
              }) format("woff"),
              url(${
                process.env.PUBLIC_URL +
                "/assets/fonts/Rockwell-Bold/Rockwell-Bold.ttf"
              }) format("truetype"),
              url(${
                process.env.PUBLIC_URL +
                "/assets/fonts/Rockwell-Bold/Rockwell-Bold.svg#Rockwell-Bold"
              }) format("svg");
          }
          ...
          @font-face {
            ...
            font-style: normal;
            src: url(${
              process.env.PUBLIC_URL + "/assets/fonts/Rockwell/Rockwell.eot"
            });
            src: url(${
              process.env.PUBLIC_URL +
              "/assets/fonts/Rockwell/Rockwell.eot?#iefix"
            }) format('embedded-opentype'),
                url(${
                  process.env.PUBLIC_URL +
                  "/assets/fonts/Rockwell/Rockwell.woff2"
                }) format('woff2'),
                url(${
                  process.env.PUBLIC_URL +
                  "/assets/fonts/Rockwell/Rockwell.woff"
                }) format('woff'),
                url(${
                  process.env.PUBLIC_URL + "/assets/fonts/Rockwell/Rockwell.ttf"
                }) format('truetype'),
                url(${
                  process.env.PUBLIC_URL +
                  "/assets/fonts/Rockwell/Rockwell.svg#Rockwell"
                }) format('svg');
          }
            ...
            <div className="row">
              <div className="col-12">
                ...
                <div className="cs-05-countdown space-mt--50">
                  <Countdown
                    date={new Date("November 07, 2021 12:12:00")}
                    renderer={Renderer}
                  />
                </div>
