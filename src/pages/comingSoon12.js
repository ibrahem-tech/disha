							...
							<div className="col-6 ml-auto mr-auto">
								...
								<div className="cs-12-logo text-center space-mb--35">
									<Link to={process.env.PUBLIC_URL + "/"}>
										<img
											src={
												process.env.PUBLIC_URL + "/assets/img/logo/logo-121.png"
											}
											className="img-fluid"
											alt=""
										/>
						...
						<div className="row">
							<div className="col-lg-10 ml-auto mr-auto">
								...
								<div className="cs-12-countdown space-mt--50">
									<Countdown
										date={new Date("November 07, 2023 12:12:00")}
										renderer={Renderer}
									/>
								</div>
						...
						<div className="row align-items-center">
							<div className="col-12 col-md-6">
								...
								<div className="cs-12-copyright">
									...
									<a
										href="https://Metrixfabrication.com/"
										target="_blank"
							...
							<div className="col-12 col-md-6">
								...
								<ul className="cs-12-social-icons d-flex align-items-center justify-content-center justify-content-md-end">
									<li>
										<a
											href="https://www.facebook.com/profile.php?id=100089626999154"
											target="_blank"
											rel="noopener noreferrer"
										>
											<ReactSVG
